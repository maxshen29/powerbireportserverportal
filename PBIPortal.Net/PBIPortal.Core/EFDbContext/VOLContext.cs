...
namespace PBIPortal.Core.EFDbContext
{
    public class PBIPortalContext : DbContext, IDependency
    {
        /// <summary>
        /// 数据库连接名称 
        /// </summary>
        public string DataBaseName = null;
        public PBIPortalContext()
                : base()
        {
        }
        public PBIPortalContext(string connction)
            : base()
        {
            DataBaseName = connction;
        }

        public PBIPortalContext(DbContextOptions<PBIPortalContext> options)
            : base(options)
        {
