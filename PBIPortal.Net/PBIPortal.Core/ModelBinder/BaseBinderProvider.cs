...
namespace PBIPortal.Core.ModelBinder
{
    public class BaseBinderProvider : IModelBinderProvider
    {
     ...
     //   public List<BinderObject> binder=new BinderObject()
        ...
        private void InitType()
        {
            ...
            AddType(typeof(List<PBIPortal.Entity.DomainModels.Sys_TableColumn>));
            AddType(typeof(PBIPortal.Entity.DomainModels.Sys_TableInfo));
        }
        /// <summary>
