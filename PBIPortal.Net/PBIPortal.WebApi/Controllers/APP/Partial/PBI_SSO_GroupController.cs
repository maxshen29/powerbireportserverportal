...
*如: [ApiActionPermission("PBI_SSO_Group",Enums.ActionPermissionOptions.Search)]
 */
...
{
    public partial class PBI_SSO_GroupController
    {
        ...
        public async Task<IActionResult> AddGroup([FromBody]PBI_SSO_Group pBI_SSO_Group)
        {
            return Json(await Service.AddGroup(pBI_SSO_Group));
        }
