  ...
  <div class="all" id="alldiv">
    ...
    <div class="content" id="content">
      <split-pane
        ...
        :default-percent="15"
      >
        <template slot="paneL" :max-percent="35" :default-percent="15">
...
export default {
  ...
  methods: {
    loginReportServer() {
      var url = this.userInfo.pbiUrl;

      url =
        url + "powerbi/login?rs:embed=true&username=" + this.userInfo.userName;
    ...
    addTab(data) {
      ...
      if (isadd) {
        ...
        if (data.type == "分页报表") {
          url = url + "report/";
          url = url + pbiUrl + "?rs:embed=true";
        } else {
          url = url + "powerbi/";
          url =
            url + pbiUrl + "?rs:embed=true&username=" + this.userInfo.userName;
    ...
    GetALLRightCatalogPBI() {
      this.http
        ...
        .then((result) => {
          ...
          //console.log(this.allcatalogrpt);
        });
    },
      ...
      this.http
        ...
        .then((result) => {
          ...
          if (result.data.length == 1) {
            ...
            if (result.data[0].rpt_type == "分页报表") {
              url = url + "report/";
            } else {
              url = url + "powerbi/";
            }
