  ...
  <div class="tm-bg" style="height: 100%; width: 100%;">
    ...
    <div class="login-contianer">
      <div class="login-project">
        <span class="project-name">Power BI数据决策支撑平台</span>
...
export default {
  created() {
    this.http
      .get(
        "/api/User/SSOLogin?token=51548dad92a5c517e906a1d98ddef6cc&src=http://192.168.2.18/reports/powerbi/公司站点/Exec%20reports%20-%20财务报表",
        {},
        "正在登陆...."
      )
      .then(result => {
